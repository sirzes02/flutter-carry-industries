...
CREATE TABLE IF NOT EXISTS `carro` (
  `id_car` smallint(6) COMMENT 'Identificador' AUTO_INCREMENT,
  `car_pla` varchar(6) COMMENT 'Placa',
...
INSERT INTO `carro` (`id_car`, `car_pla`, `car_mar`, `car_mod`, `car_pre`, `car_tip`, `car_usa`) VALUES
	(NULL, NULL, 'Ford', 2019, 28.39, 'Camionetas', b'1'),
	(NULL, NULL, 'Kia', 2020, 22.9, 'Camperos', b'1'),
	(NULL, NULL, 'Chevrolet', 2019, 22.9, 'Automovil', b'1'),
	(NULL, NULL, 'Ford', 2020, 120, 'Automovil', b'0'),
	(NULL, NULL, 'Nissan', 2019, 30.5, 'Automovil', b'0'),
	(NULL, NULL, 'Renault', 2019, 16, 'Camperos', b'1'),
	(NULL, NULL, 'Kia', 2020, 30.5, 'Automovil', b'1'),
	(NULL, NULL, 'Hyundai', 2019, 45.8, 'Camionetas', b'0'),
	(NULL, NULL, 'Nissan', 2020, 11.3, 'Camionetas', b'0'),
	(NULL, NULL, 'Chevrolet', 2020, 136.99, 'Camionetas', b'0'),
	(NULL, NULL, 'Toyota', 2019, 29, 'Carga', b'0'),
	(NULL, NULL, 'Renault', 2020, 16, 'Carga', b'1'),
	(NULL, NULL, 'Toyota', 2019, 45.8, 'Camionetas', b'1'),
	(NULL, NULL, 'Hyundai', 2020, 95.99, 'Automovil', b'0');
...
INSERT INTO `usuarios` (`usu_cor`, `usu_nom`, `usu_ape`, `usu_tel`, `usu_dir`, `usu_pas`, `usu_car_rec`) VALUES
	...
	('luis.giraldo@usc.edu.co', 'luis', 'giraldo', '3008651203', 'Calle 102 #114-22', '232839', NULL),
